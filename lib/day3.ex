defmodule Day3 do
  ...
  def part1() do
    in1 = @raw1 |> String.split(",")
    in2 = @raw2 |> String.split(",")
    ...
    point =
      Set.intersection(
        Enum.into(path1, HashSet.new),
        Enum.into(path2, HashSet.new))
     |> Set.to_list()
  ...
  def part2() do
    ...
    point =
      ...
      |> Set.to_list()
      |> Enum.map(fn point ->
          Enum.find_index(path1, fn p -> p == point end) + Enum.find_index(path2, fn p -> p == point end)
        end)
      |> Enum.min()
